...
menuBtn.addEventListener("click", ()=>{
	window.location.href = "/Game 1/game1.html";
})
//: ----------------- End ----------------- ://
...
async function loadWindow(){
	...
	const randomNumbers = utils.randomSelect(0, data.dataArray.length - 1, total_cards*2);
